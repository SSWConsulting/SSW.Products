...
const SubGroupTrigger = ({ label }: { label: string }) => {
  return (
    <NavigationMenu.Trigger className="outline-none text-base h-fit flex items-center w-full gap-2 px-3  rounded  transition-colors whitespace-nowrap" style={{ writingMode: 'horizontal-tb' }}>
      {label}
