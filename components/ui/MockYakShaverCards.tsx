...
export function ExampleYakShaverCard() {
  ...
  export function HeroYakShaverCard() {
    return (
      <div className="bg-gradient-to-r to-[#1f1f1f] via-[#1e1e1e] from-[#292929]  p-3 border-2  text-xs border-[#4D4D4E]/30 shadow-2xl rounded-xl text-white w-full ">
        ...
        <TypingAnimation
          delay={1000}
          className="items-center md:h-[30px] text-xs font-normal mb-2 flex bg-white/5  rounded-lg px-2 py-1 border-2 border-[#4E4E4F]/30 lg:whitespace-nowrap overflow-hidden text-ellipsis"
        >
