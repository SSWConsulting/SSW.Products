...
> ⚠️ **Important:** This option is only available on invoices in **unlocked periods**. If the period has been locked off, please refer to [Allocate credit](https://sswtimepro.com/docs/invoices/allocate-credit)
