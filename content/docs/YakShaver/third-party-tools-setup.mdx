...
While the [browser extension](recording-work-item-browser-extension) and [Microsoft Teams](recording-work-item-teams) are the recommended ways to get started with YakShaver, we also support a variety of third-party recording tools. These tools offer additional flexibility and features like keyboard shortcuts for power users who want to optimize their workflow.
