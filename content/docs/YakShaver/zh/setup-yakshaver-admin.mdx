...
要集成 Azure DevOps，请在组织的用户管理中为 YakShaver 应用分配基础许可证和项目贡献者角色。了解更多：[https://yakshaver.ai/zh/docs/add-azure-devops-projects](https://yakshaver.ai/docs/add-azure-devops-projects)
