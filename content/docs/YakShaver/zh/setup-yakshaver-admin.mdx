...
YakShaver 通过 Microsoft Entra ID 连接到您的 Microsoft 365 租户。它是一个多租户云应用，使用管理员同意流程请求 Microsoft Graph 应用权限（组织范围的服务间访问）。您的租户管理员为您的组织批准一次访问。YakShaver 不会在您的租户中创建资源。
...
* 能够批准组织范围内所有仓库访问的组织所有者
* 能够授权访问其个人仓库和公共仓库的管理员
