...
使用我们的设置向导，轻松为您的组织启动并运行 YakShaver！请观看下面的视频并查看所需权限，以确保顺利完成设置过程。
...
YakShaver 通过 Microsoft Entra ID 连接到您的 Microsoft 365 租户。它是一个多租户云应用，使用管理员同意流程请求 Microsoft Graph 应用权限（组织范围的服务到服务访问）。您的租户管理员为您的组织批准一次访问。YakShaver 不会在您的租户中创建资源。
...
* 元数据读取访问 - 读取基本仓库信息、分支和设置（用于获取项目信息）
* 代码、问题、组织项目和仓库项目的读写访问 - 完全访问仓库内容、问题跟踪和项目看板（用于创建和更新项目中的工作项）

**用户权限：**

* 电子邮件地址读取访问 - 访问您的主电子邮件地址和公开电子邮件信息（用于用户识别）
