...
1. Set a nickname - In the Portal, Go to [User Settings](https://portal.yakshaver.ai/users), select a user, and add a nickname in the Edit User screen. Each user can have only one nickname at a time.
