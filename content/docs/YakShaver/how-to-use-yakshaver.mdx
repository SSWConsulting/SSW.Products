...
YakShaver streamlines work item creation by converting your screen recordings into structured documentation. Choose your preferred recording method below and follow the setup instructions to get started. For the best experience, we recommend starting with the YakShaver browser extension or Microsoft Teams.

## Browser Extension Setup
The browser extension is the fastest way to get started with YakShaver, offering seamless integration with Chrome and Edge browsers.
