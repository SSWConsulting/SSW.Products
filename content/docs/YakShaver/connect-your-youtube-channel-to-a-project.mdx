...
seo:
  ...
  description: Link your YouTube channel to your YakShaver project to get shareable YouTube links & embeds every time you do a YakShave.
title: Connect your YouTube Channel to a Project
...
1. Sign in to the client portal\
   Go to **[Projects](https://portal.yakshaver.ai/projects)** and open the project you want to link.
