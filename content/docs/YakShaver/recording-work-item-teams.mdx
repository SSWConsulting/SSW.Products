...
1. When done, leave the call or stop the recording to send it to YakShaver for processing

   ![](/YakShaver/Blogs/start-recording.png)
   **Figure: More | Record and Transcribe | Start Recording**
2. Check Teams to confirm YakShaver has processed the video and created the task

   ![](/YakShaver/yakshaver-is-done.png)
   **Figure: YakShaver task confirmation on Teams**
3. ✅ Done - You will receive one of the 3 email types (based on the project):
