...
* **Confidentiality considerations:** If your video contains confidential information, even when unlisted, can lead to the video being removed by YouTube. See [YouTube's Community Guidelines.](https://support.google.com/youtube/answer/9288567?hl=en)

## How to set up YouTube uploads:

1. Go to the project where you want to upload videos through the [portal](https://portal.yakshaver.ai/projects)
