...
The browser extension is the recommended way to get started with YakShaver. It offers the fastest setup process and the simplest way to create work items directly from Chrome or Edge without requiring additional software.
