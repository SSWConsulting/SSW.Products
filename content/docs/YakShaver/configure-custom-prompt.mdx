...
Admins can view and edit this prompt in the **Tenant Prompt Configuration** card on the [System Info page](https://portal.yakshaver.ai/systeminfo).
...
Admins can set this by opening a [project](https://portal.yakshaver.ai/projects) and editing the **Custom System Prompt** field.
