...
Tenant level prompts apply to all projects under current tenant. All tenants starts with the YakShaver default prompt:
...
Admins can view and edit this prompt in the **Tenant Prompt Configuration** card in the [System Info page](https://portal.yakshaver.ai/settings/systeminfo).
...
⚠️ **Note:** Project-level prompts override the tenant-level prompt.
