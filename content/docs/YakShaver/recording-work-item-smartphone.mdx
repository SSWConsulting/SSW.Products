...
The process is easy, jsut record your screen (don't forget to include microphone audio) and then upload the recording to your Recordings OneDrive folder. Then YakShaver will pick up the video and processs it.
...
1. Record your YakShave and then upload it to your OneDrive Recordings folder.
...
2. Record your YakShave and it should be uploaded to your OneDrive and picked up by YakShaver
