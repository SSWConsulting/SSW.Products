...
* 2b. Check the status of your recent shave and re-run it if the option is available
  This can happen when the Shave is pending because the user has not answered a question from the bot (like which project to add it in). 
* 2c. If your recent shave does not appear (or you cannot re-run it), continue to step 3

## 3. If the bot doesn't respond, or the above steps haven't worked
