...
2. If you haven't set up YakShaver, you will be prompted to head to the [portal](https://portal.yakshaver.ai/). See [setting up YakShaver for your organization](/setup-yakshaver-admin)
