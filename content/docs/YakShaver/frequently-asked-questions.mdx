...
## 10. What does each shave status mean in the [My Shaves](https://portal.yakshaver.ai/my-shaves) page?

* Pending: The shave is currently being processed

* Completed: The shave has been successfully processed and delivered

* Error - The shave processing encountered an error and could not be completed

* Cancelled - The shave was manually cancelled by the user

* Insufficient Credits - The shave could not be completed due to lack of credits

* Fallback - A fallback email was sent when the initial intent of user wasn't completed
