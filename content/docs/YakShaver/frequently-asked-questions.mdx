...
Yes, Yakshaver works in most of the worlds languages. [See supported OpenAI list](https://github.com/openai/whisper?tab=readme-ov-file#available-models-and-languages).
