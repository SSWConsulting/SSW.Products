...
YakShaver is great for giving context and showing exactly what the user experiences. However, if you're requesting **text changes**, especially ones that involve rewording, improvements to phrasing, or tone adjustments, it's better to create the Issue or PBI manually.
