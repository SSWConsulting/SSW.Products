...
<Youtube thumbnail="https://img.youtube.com/vi/Wtrk1KZB_aI/maxresdefault.jpg" externalVideoLink="https://www.youtube.com/embed/Wtrk1KZB_aI?si=MBlUkVSRw2Kf3UxB" size="large" caption="EagleEye - How to use Webhooks (5 min) | SSW EagleEye" />

Explore the **Tags** page in your EagleEye portal.
...
![](/EagleEye/Features/Webhook-Example.png)**Figure: EagleEye Portal | Tags | Add New Tag | Example of a webhook implementation**
