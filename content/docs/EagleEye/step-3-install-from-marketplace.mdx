...
* **Capacity**: Set tokens per minute. You can [view and request quotas in Foundary portal](https://learn.microsoft.com/en-us/azure/ai-foundry/how-to/quota?view=foundry-classic#view-and-request-quotas-in-foundry-portal)
