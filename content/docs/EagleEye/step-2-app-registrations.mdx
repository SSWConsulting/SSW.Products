...
**Note:** This is a critical security configuration step that prevents unauthorized users from accessing your EagleEye Portal and should be completed before proceeding to the next step.
