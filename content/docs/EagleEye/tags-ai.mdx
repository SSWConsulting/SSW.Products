...
Learn more on [Do you send yourself emails?](https://www.ssw.com.au/rules/send-to-myself-emails/)

Explore the **Tags** page in your EagleEye portal.

![](/EagleEye/Features/AI-Tag-Example-2.png)**Figure: EagleEye Portal | Tags | Add New Tag | Example of AI prompts for the "To myself" tag**
