...
* 📃 Non-AI Tags – Simple rules-based tags.
* 🤖 AI Tags – AI-driven tags that identify relevant terms and context.
* 🤖 AI with Mentions Tags – AI-powered tags that can extract and identify specific people mentioned in emails.

Learn more about each of these tags in the **Features **section.
