...
For database usernames/passwords, use [Manage Credentials for Database](./manage-database-credentials).
...
* App registration updates: **[Owner](https://learn.microsoft.com/en-us/entra/identity/role-based-access-control/delegate-app-roles#assign-application-owners)**
* Key Vault secret updates: **[Key Vault Secrets Officer](https://learn.microsoft.com/en-us/azure/role-based-access-control/built-in-roles/security#key-vault-secrets-officer)**
