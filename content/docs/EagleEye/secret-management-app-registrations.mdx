...
Use these least-privilege roles:

* App registration updates: **[Owner](https://learn.microsoft.com/en-us/entra/identity/role-based-access-control/delegate-app-roles#assign-application-owners)** on the target app registration
* Key Vault secret updates: **[Key Vault Secrets Officer](https://learn.microsoft.com/en-us/azure/role-based-access-control/built-in-roles/security#key-vault-secrets-officer)** on the EagleEye Key Vault

Reference docs:

* [Azure RBAC overview](https://learn.microsoft.com/en-us/azure/role-based-access-control/overview)
* [Application Administrator (broader alternative)](https://learn.microsoft.com/en-us/entra/identity/role-based-access-control/permissions-reference#application-administrator)
* [Key Vault Administrator (broader alternative)](https://learn.microsoft.com/en-us/azure/role-based-access-control/built-in-roles/security#key-vault-administrator)
* [Assign a Key Vault access policy (legacy model)](https://learn.microsoft.com/en-us/azure/key-vault/general/assign-access-policy?tabs=azure-portal)
