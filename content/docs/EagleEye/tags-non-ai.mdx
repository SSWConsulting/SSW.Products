...
Learn more on [Do you know what happens at a Sprint Review meeting?](https://www.ssw.com.au/rules/what-happens-at-a-sprint-review-meeting/)

Explore the **Tags** page in your EagleEye portal.

![](/EagleEye/Features/Non-AI-Tag.png)**Figure: EagleEye Portal | Tags | Add New Tag | Example of a non-AI rule for the "Sprint Review/Retro" tag**
