...
**Note**: If you don't have existing app registrations, you can create them during deployment. Refer to the [App Registration Creation Guide](#app-registration-creation-guide) section below.
...
### Engine App Registration (SSW\.EagleEye.Engine)

This app registration is used by the Engine CLI and API to access Microsoft Graph.
...
1. Go to **Manage** > **API permissions** > **Add a permission**
...
2. Add description: `EagleEye Engine Secret`
3. Select expiration period
4. Click **Add**
5. **Important**: Copy and store the secret value immediately - it will only be shown once. You'll need this during deployment

### EagleEye API (`SSW.EagleEye.Api`)
...
### EagleEye Portal (`SSW.EagleEye.Portal`)
