...
You will need your Azure Tenant ID:
   ...
   2. Search Entra -> Select Microsoft Entra ID
   ![Manage Tenants](/EagleEye/entra.png)
   3. Manage Tenants -> Select Organization Id of your Tenant
...
⚠️ After deployment, **remove the secret value from any temporary notes (clipboard, notepad, etc.)**  
