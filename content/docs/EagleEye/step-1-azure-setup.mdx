...
seo:
  ...
  description: 'Configure your Azure subscription, register required resource providers, and gather tenant and group details needed before installing SSW EagleEye from the Azure Marketplace.'
...
<OutlineBox
  content={<>
    Note: To perform email analysis, EagleEye needs permission to read user mailboxes.
