...
seo:
  title: Tags
  description: 'Categorize and analyze emails with EagleEye''s smart tagging system—supporting rules-based tags, AI tags, and AI with Mentions for extracting names.'
title: What are Tags?
...
Tags are custom, user-definable labels that you apply to emails (or other items) to classify and group them - making your data easier to filter, search, and analyze.

{{ image here }}

The EagleEye system supports three types of tags:
...
Please have a look at the **Features** section to learn more about each of those tag types.

If you want to start creating your own tags, go to the **Tags** page in your EagleEye portal.
