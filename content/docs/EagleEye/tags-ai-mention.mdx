...
Learn more on [Do you use 'Checked by xxx'?](https://www.ssw.com.au/rules/checked-by-xxx/)

Explore the **Tags** page in your EagleEye portal.

![](/EagleEye/Features/AI-Mention-Tag-Example.png)**Figure: EagleEye Portal | Tags | Add New Tag | Example of an AI mentions prompt for the "Checked By" tag**
