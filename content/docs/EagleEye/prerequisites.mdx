...
* **Azure OpenAI** quota available in your subscription. You can [view and requst quotas in Foundary portal](https://learn.microsoft.com/en-us/azure/ai-foundry/how-to/quota?view=foundry-classic#view-and-request-quotas-in-foundry-portal)
