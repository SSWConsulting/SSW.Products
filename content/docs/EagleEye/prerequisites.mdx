...
You need **three Azure App Registrations** for EagleEye:
...
> Remember to repeat **Steps 1 & 2** for 3 apps registrations
...
2. **Copy the full scope URL** (e.g., `api://xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx/access_as_user`)
