...
5. If creating a new group:
   - Follow this [guide](https://learn.microsoft.com/en-us/entra/fundamentals/how-to-manage-groups) to create and configure a new Microsoft 365 group
   - Ensure you select **Microsoft 365** as the Group type during creation
   ![Group Type](/EagleEye/group-type.png)
