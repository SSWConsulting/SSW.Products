  ...
  return (
    <>
      <div className="grid grid-cols-1 pt-navBarHeight-mobile sm:pt-navBarHeight md:grid-cols-[1.25fr_3fr] lg:grid-cols-[1fr_3fr] max-w-[90rem] mx-auto min-h-screen">
        {/* LEFT COLUMN 1/3 */}
        <div className="hidden md:block w-full py-8 rounded-lg text-white top-10 self-start px-6 bg-gray-darkest translate-y-20 overflow-y-auto [scrollbar-width:thin] [scrollbar-color:theme(colors.gray.neutral)_transparent] max-h-offset-20 sticky">
